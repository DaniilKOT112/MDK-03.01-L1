...
# Определение числа приоритетов и вероятностей
priorities_number = 5
priorities_probability = [0.2, 0.2, 0.1, 0.2, 0.3]

# Инициализация пользовательского интерфейса и генератора данных
ui = Ui()
generator = Generator()
...
def run():
    ...
    # Получение параметров от пользовательского интерфейса
    ...
    # Генерация данных о времени получения и обслуживания заявок, а также их приоритетов
    ...
    while True:
        ...
        # Обновление показателей в интерфейсе
